...
tinyMCEPopup = {
	...
	resizeToInnerSize : function() {
		...
		setTimeout(function() {
			...
			a.editor.windowManager.resizeBy(a.getWindowArg("mce_width") - b.w,
					a.getWindowArg("mce_height") - b.h, a.id || window)
		}, 10)
	},
	...
	requireLangPack : function() {
		...
		if (a && b.editor.settings.language
				...
				&& b.editor.settings.language_load !== false) {
	...
	_onDOMLoaded : function() {
		...
		if (!b.editor.getParam("browser_preferred_colors", false)
				|| !b.isWindow) {
